  ...
  return (
    <>
      ...
      >
        <div
          ref={modalContent}
          className="bg-white dark:bg-white border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
        >
          {/* Search form */}
          <form className="border-b border-slate-200 dark:border-slate-700">
            <div className="relative">
              ...
              <input
                id={searchId}
                className="w-full dark:text-slate-300 bg-white dark:bg-white border-0 focus:ring-transparent placeholder-slate-400 dark:placeholder-slate-500 appearance-none py-3 pl-10 pr-4"
                type="search"
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-slate-800 dark:text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
                    to="#0"
