...
function DropdownNotifications({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-white border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${
