...
function Tooltip({ children, className, bg, size, position }) {
  ...
  const colorClasses = (bg) => {
    switch (bg) {
      ...
      case "dark":
        return "bg-slate-700 text-slate-800 border-slate-600";
      default:
        return "text-slate-600 bg-white dark:bg-slate-700 dark:text-slate-800 border-slate-200 dark:border-slate-600";
    }
  };
