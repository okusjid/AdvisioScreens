...
function Sidebar({ sidebarOpen, setSidebarOpen, adList, adOpen, setAdOpen }) {
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg
                              ...
                              viewBox="0 0 12 12"
                            >
                              <path d="M5.9 11.4L1.5 6l4.3-4.4L4.5.6 0 6l4.5 5.4z" />
                            </svg>
                          </div>
                        </div>
                      </a>
                        ...
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            ...
                            {adList &&
                              <ul className="ps-3">
                                {adList.map((ad, index) =>
                                  <li key={index} onClick={() => setAdOpen(index)} className={`text-gray-${index === adOpen ? '100' : '500'}`} style={{cursor: 'pointer'}}>
                                    {ad.name}
                                  </li>
                                )}
                              </ul>}
