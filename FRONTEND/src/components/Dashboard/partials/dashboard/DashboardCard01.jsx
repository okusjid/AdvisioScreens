...
function DashboardCard01() {
  ...
  return (
    <div className="rounded-md flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white text-dark:text-slate-800 shadow-lg rounded-md border border-slate-200 dark:border-slate-700">
      ...
      <div className="grow max-sm:max-h-[128px] xl:max-h-[128px] rounded-md">
