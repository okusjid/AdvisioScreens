  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-16 animate-slideUp">
        {/* Box 1 */}
        <div className="max-w-md bg-blue-100 shadow-lg rounded-lg p-8 hover:shadow-2xl transition duration-500">
      ...
      <div className="text-center mt-16">
        <Link
          to="/contact"
          className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition duration-300 shadow-lg animate-bounce"
        >
          Get in Touch
        </Link>
      </div>
