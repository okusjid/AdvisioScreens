    ...
    <div className="bg-white relative flex items-center justify-center overflow-hidden z-50">
      <div className="relative mx-auto h-full px-4 pb-20 md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className="relative">
            <div className="relative top-0 left-0 z-10 opacity-100 flex items-center">
              {/*<div className="relative top-0 left-0 z-10 opacity-100 flex items-center">
                <img
                  src={Logo}
                  className="w-36 h-auto max-h-16 rounded-md shadow-md"
            ...
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              <h2 className="text-5xl font-extrabold text-center  italic text-blue-800 mb-12 tracking-tight animate-fadeIn">
      ...
      <div className="absolute -bottom-24 left-10 z-0 opacity-10">
        <svg
          ...
          height="800px"
          viewBox="0 0 24 24"
          className="w-96 z-0 h-full object-fill fill-pink-700 text-gray-300"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
      ...
      <div className="absolute top-10 left-3/4 z-0 opacity-10">
        <svg
          ...
          viewBox="0 0 256 256"
          xmlns="http://www.w3.org/2000/svg"
          className="w-96 z-0 h-full object-fill fill-blue-600 text-blue-300"
        >
          <path
